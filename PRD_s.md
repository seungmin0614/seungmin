...
| **프로젝트명**     | "고령자 스마트홈"            |
| **제작자**         | `[park]`                                   |
| **BLE 기기명**     | `ESP_mini (예: `ESP_student01`)            |
| **OLED 이미지**    | `image/snoppy.pbm` (예: `img/pikachu.pbm`) |
| **메인 컬러 테마** | 흰색계열                                   |
...
ble = bluetooth.BLE()
p = ble_library.BLESimplePeripheral(ble, "ESP_[내 기기명]")
...
- [ ] **프로젝트명** 변경: `[내 이름]`을 본인 이름으로 수정
- [ ] **BLE 기기명** 변경: `ESP_[내 기기명]`을 본인 기기명으로 수정 (예: `ESP_minsu`)
